...
> 
> 📄 Примечание: Если онлайн-демо временно недоступно из-за исчерпания квоты бесплатного API, пожалуйста, ознакомьтесь со [скриншотами, архитектурными схемами и результатами тестирования](IMPLEMENTATION_GUIDE.md), представленными в репозитории. Они отражают работу проекта и его функциональные возможности.
...
📚 [Ознакомиться со скриншотами, архитектурными схемами и результатами тестирования можно тут](IMPLEMENTATION_GUIDE.md)  
